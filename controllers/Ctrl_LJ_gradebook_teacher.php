...
class Ctrl_LJ_gradebook_teacher extends MY_Controller {
    ...
    public function get_gradingSystem()
    {
    	...
    	{
    		$users = $this->Mod_LJ_gradebook_teacher->select_from_cron_teacher($myID);
    	}
        else
        {
            $users = $this->Mod_LJ_gradebook_teacher->select_from_cron_student($myID); 
        }
        ...
        $center_text = $this->load->view('view_LJ_gradebook_teacher', array('data' => $objectarray), true); 
